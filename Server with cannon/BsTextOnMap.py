...
prefixAnim = {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0),250*4:(1,0,1)})
        ...
        def text():
            ...
            bs.animate(t, 'scale', {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0),250*4:(1,0,1)})
            bsUtils.animateArray(t, 'color', 3, prefixAnim, True)                
                t = bs.newNode('text',
