...
class Artillery(object):
    ...
    def strike(self):
        if self.target is not None:
            ...
            bs.gameTimer(10, bs.Call(launchBomb))
            bs.gameTimer(15, bs.Call(launchBomb))
            bs.gameTimer(20, bs.Call(launchBomb))
            bs.gameTimer(25, bs.Call(launchBomb))
            bs.gameTimer(30, bs.Call(launchBomb))
            bs.gameTimer(35, bs.Call(launchBomb))
            bs.gameTimer(40, bs.Call(launchBomb))
            bs.gameTimer(45, bs.Call(launchBomb))
            bs.gameTimer(50, bs.Call(launchBomb))
            bs.gameTimer(55, bs.Call(launchBomb))
            bs.gameTimer(60, bs.Call(launchBomb))
            bs.gameTimer(65, bs.Call(launchBomb))
            bs.gameTimer(70, bs.Call(launchBomb))
            bs.gameTimer(75, bs.Call(self.drop))
    ...
    def drop(self):
        ...
        bs.gameTimer(1, bs.Call(launchBombDrop))
        bs.gameTimer(6, bs.Call(launchBombDrop))
        bs.gameTimer(100, bs.Call(launchBombDrop))
        bs.gameTimer(150, bs.Call(launchBombDrop))
        bs.gameTimer(400, bs.Call(launchBombDrop))
        bs.gameTimer(500, bs.Call(launchBombDrop))
        bs.gameTimer(600, bs.Call(launchBombDrop))
        bs.gameTimer(700, bs.Call(launchBombDrop))
        bs.gameTimer(800, bs.Call(launchBombDrop))
        bs.gameTimer(900, bs.Call(launchBombDrop))
        bs.gameTimer(1000, bs.Call(launchBombDrop))
        bs.gameTimer(1200, bs.Call(launchBombDrop))
        bs.gameTimer(1300, bs.Call(launchBombDrop))
...
class RailBullet(bs.Actor):
    ...
    def __init__(self, position=(0, 10, 0), velocity=(0, 0, 0)):
        ...
        bs.gameTimer(100, emitter)

    def emit(self):
        bs.Blast(
            position=self.node.position,
            blastType='impact',
            blastRadius=2).autoRetain()
    ...
    def boom(self):
        ...
        b.node.extraAcceleration = (self.vel[0]*900, -100, self.vel[2]*900)
